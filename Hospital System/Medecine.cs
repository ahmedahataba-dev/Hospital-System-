...
namespace Hospital_System
{
    public class Medicine
    {
        ...
        public Medicine(int id, string name, double price, int quantity, int numberOfStrips, int numberOfTabletsPerStrip)
        {
            MedicineId = id;
            Name = name;
            Price = price;
        ...
        public override string ToString()
        {
            ...
            return $"{MedicineId} | {Name} | {Price} | {Quantity} | {NumberOfStrips} | {NumberOfTabletsPerStrip}";
        }
