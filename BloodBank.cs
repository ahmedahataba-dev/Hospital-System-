    ...
    public class BloodBank
    {
        ...
        private void SaveBloodData()
        {
            try
            {
             ...
             catch (Exception ex) { System.Windows.Forms.MessageBox.Show("Error saving blood data: " + ex.Message); }
        }
        ...
        private void SaveDonors()
        {
            try
            {
             ...
             catch (Exception ex) { System.Windows.Forms.MessageBox.Show("Error saving donors: " + ex.Message); }
        }
        ...
        private void SaveTransfers()
        {
            try
            {
             ...
             catch (Exception ex) { System.Windows.Forms.MessageBox.Show("Error saving transfers: " + ex.Message); }
        }
