      ...
      : base(name, age, gender, nationalId, phoneNumber, email, address, salary,/*, arrivaltime, departuretime,*/ experienceyears)
        ...
        internal static void RunDoctorMenu(Hospital neurai)
        {
            ...
            while (doctorMenu)
            {
                ...
                string docChoice = Console.ReadLine() ?? string.Empty;
                ...
                else if (docChoice == "2")
                {
                    ...
                    string docName = Console.ReadLine() ?? string.Empty;
                ...
                else if (docChoice == "3")
                {
                    ...
                    string rawBloodType = Console.ReadLine() ?? string.Empty;
                    string bloodType = "";
                    ...
                    string rankChoice = Console.ReadLine() ?? string.Empty;
